	...
	<view>
		...
		<view class="main">
			...
			<view class="psd-input">
				...
				<view class="psd-input-input" style="font-weight: 700;margin-top: 80rpx;" @click="gotoLogin">ok
				</view>
			</view>
		</view>
	...
	export default {
		...
		methods: {
			gotoLogin() {
				...
				api.reSet(this.email,this.verificationCode,this.password).then(res=>{
					if(res.statusCode == '200') {
						uni.showToast({
							icon:"success",
							title:"reseet success"
						})
						uni.clearStorage()
						uni.navigateTo({
							url:"../login/login"
